...
## User Stories (Tracked in Jira) (max 10 marks) 
  - Correctly formulated user stories (max 2 marks)
    ...
    The template is "as x, i want to y so that I can z", you're missing the "so that I can z" for many of your stories. 
...
## Tracking on Jira  (max 20 marks) 
  ...
  - Did you start all stories for sprint one? (max 2 marks)
    ...
    Your Mark: 1 (two stories not started)
...
Tracking on Jira Total Mark: 9 / 20
